...
7:                                                ; preds = %4, %3
  ...
  %9 = sext i32 %8 to i64
  %10 = getelementptr inbounds [5 x i32], ptr @rddata, i64 0, i64 %9
...
8:                                                ; preds = %5
  ...
  %18 = call signext i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef signext %14, i32 noundef signext %15, i32 noundef signext %16, i32 noundef signext %17)
  %19 = load i32, ptr %4, align 4
  %20 = add nsw i32 %19, 1
